...
from .ast import DB, ReqlQuery, expr
from .encoder import (
    ReqlDecoder,
    ReqlEncoder,
)
...
from .net.handshake import BaseHandshake, HandshakeV1_0
from rethinkdb.ql2_pb2 import Query as PbQuery
from .net.msg import Query
...
# def maybe_profile(value: Union["DefaultCursor", str], res: "Response") -> Union["DefaultCursor", str]:
#     """
...
#         raise RqlDriverError(f"Invalid wait timeout '{wait}'")
...
class Connection:  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(  # nosec
        ...
        password: str = "",
        timeout: int = 0,
        ssl: dict | None = None,  # pylint: disable=redefined-outer-name
        ...
        **kwargs,
        ...
        self._instance: ConnectionInstance | None = None
        self._next_token: int = 0
        self._repl: Repl = Repl()

        self._json_encoder = kwargs.pop("json_encoder", ReqlEncoder)
        self._json_decoder = kwargs.pop("json_decoder", ReqlDecoder)
    ...
    def get_json_decoder(self, query: Query):
        """
        Return the related json decoder.
        """
        return (query._json_decoder or self._json_decoder)(reql_format_opts=query.kwargs)

    def get_json_encoder(self, query: Query):
        """
