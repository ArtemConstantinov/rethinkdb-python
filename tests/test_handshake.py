...
from rethinkdb.core.net.handshake import (
    BaseHandshake,
    HandshakeState,
    HandshakeV1_0
)
...
@pytest.fixture
def base_handshake() -> BaseHandshake:
    """
...
# def test_handshake_stage_stepping(base_handshake: BaseHandshake) -> None:
#     """
...
# def test_handshake_v1_0_stage_stepping(handshake: HandshakeV1_0) -> None:
#     """
#     Test that the handshake states can be incremented.
#     """
...
def test_handshake_v1_0_initialization(handshake: HandshakeV1_0) -> None:
    """
...
# def test_handshake_v1_0_reset(handshake: HandshakeV1_0) -> None:
#     """
...
def test_handshake_v1_0_invalid_state(handshake: HandshakeV1_0) -> None:
    """
...
@patch("rethinkdb.core.handshake.base64")
def test_init_connection(mock_base64: MagicMock, handshake: HandshakeV1_0) -> None:
    """
    Test connection initialization works.
    """
    handshake.next_state = Mock()
    handshake.state = HandshakeState.INITIAL_CONNECTION
    encoded_string = "test"
...
def test_init_connection_unexpected_response(handshake: HandshakeV1_0) -> None:
    """
...
def test_read_response(handshake: HandshakeV1_0) -> None:
    """
...
def test_decode_json_response_auth_error(handshake: HandshakeV1_0) -> None:
    """
...
def test_decode_json_response_driver_error(handshake: HandshakeV1_0) -> None:
    """
...
def test_read_response_error_received(handshake: HandshakeV1_0) -> None:
    """
...
def test_read_response_protocol_mismatch(handshake: HandshakeV1_0) -> None:
    """
...
def test_prepare_auth_request(handshake: HandshakeV1_0) -> None:
    """
...
def test_prepare_auth_request_invalid_nonce(handshake: HandshakeV1_0) -> None:
    """
...
def test_read_auth_response(handshake: HandshakeV1_0) -> None:
    """
...
def test_read_auth_response_invalid_server_signature(handshake: HandshakeV1_0) -> None:
    """
